    ...
    <section className="relative overflow-hidden bg-brand-band py-20 text-white lg:py-24">
      ...
      <Container className="relative">
        <div className="grid gap-10 lg:grid-cols-[1fr_2fr] lg:items-center">
          <Reveal>
            <span className="eyebrow text-accent-100">Our Impact</span>
            <h2 className="mt-3 text-3xl font-bold text-white sm:text-4xl">
              Creating Lasting Change
            </h2>
            <p className="mt-4 text-white/80">
              Real numbers behind real lives — the measurable difference made
              with and for people with disabilities and marginalized
              communities.
            </p>
            <Button href="/programs" variant="white" className="mt-6">
              See Our Impact <ArrowRight />
            </Button>
          </Reveal>
